...
// lives in ~core/messaging/router: OBSERVED_EVENT, PAGE_ERROR_OBSERVED, and
// GET_CONTENT_SCRIPT_SETTINGS are the whole content-script API; everything
// else requires an extension-page sender.
