...
export const DEBUG_METRICS = [
  {
    field: "watchingCompanies",
    label: "Watching",
    title: "Every distinct third party observed on this tab — named plus not-yet-classified"
  },
  { field: "identifiedObservers", label: "Identified", title: "Observed third parties our DB has a source-backed name for" },
  {
    field: "unclassifiedParties",
    label: "Not classified",
    title: "Distinct third parties observed but not yet codified in our tracker DB"
  },
  {
    field: "privacyTradeObservers",
    label: "Privacy-trade",
    title: "Source-backed active observers in the no-trade or ads-trade categories"
  },
  ...
  { field: "recordedEvents", label: "Events", title: "Raw page-activity events recorded on this tab, excluding extension diagnostics" },
  {
    field: "storedEvents",
    label: "Stored events",
    title: "All events retained for this tab, including diagnostics — what the per-tab cap acts on"
  },
  {
    field: "unclassifiedObservations",
    label: "Unclassified rows",
    title: "Grouped third-party observations not yet attributed to tracker records"
  },
  { field: "persistenceObservations", label: "Storage rows", title: "Grouped browser storage and cache observations" },
  {
    field: "localPageSignals",
    label: "Local page signals",
    title: "Consent plumbing and identity-digest preparation observed in the page itself"
  },
